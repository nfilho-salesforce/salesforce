...
**Date:** 2026-09-21 · **Status:** superseded by `decisions/0002-both-cuts-in-scope-phased.md` · **Source:** scopezilla-recommended

> **Superseded 2026-09-21.** This ADR was generated by a background discover run without a direct scope confirmation from the user. When asked directly in a follow-up session, the user confirmed both Deck 1 (guichê tático) and Deck 2 (Headless) should be in scope for this SOW, phased — not Deck 2 as out-of-scope vision. See `decisions/0002` for the current decision. Kept here for the record of the reasoning that was overridden.

# Fase 3 — Financeiro — Folha, Motor de Split & Conciliação (19/out – 8/nov · Sem. 10-12) (DATAPREV-PAT)
...
Phase-level user-outcome claims a stakeholder would walk through to feel "Fase 3 is done." Run them in conversation with the user; mark `- [x]` somente quando o usuário concordar. Os walkthroughs de aceite por intent vivem em `11-intents-3.md`.
...
**Dependências:** Fase 0 (gateway selecionado — dependência dura), Fase 1 (E05 integração on-premise com o gateway, E08 residência/soberania). E03 depende de E01 + E05 + E08 + o gateway contratado.
...
Quando esta fase for aceita, pergunte ao usuário: *"Salvar esta execução como recipe para repetirmos na Fase 4?"* A recipe deve capturar: as decisões de modelo de dados feitas acima, os padrões de nomenclatura confirmados em `03-glossary-and-naming.md`, e quaisquer resoluções de perguntas do modo Build que surgiram.

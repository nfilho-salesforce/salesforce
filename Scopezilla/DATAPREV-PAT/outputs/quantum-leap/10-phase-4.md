# Etapa 4 — Homologação, Carga Mínima, Adoção & Go-live PROD (9/nov – 15/nov · Sem. 13) (DATAPREV-PAT)
...
Phase-level user-outcome claims a stakeholder would walk through to feel "Etapa 4 is done." Run them in conversation with the user; mark `- [x]` somente quando o usuário concordar. Os walkthroughs de aceite por intent vivem em `11-intents-4.md`.
...
**Dependências:** Etapa 1 (E05 para extração/carga). E07 depende de E05. E09 é transversal — sua comunicação começa na Etapa 1 e culmina aqui. A homologação depende do encerramento das jornadas da Etapa 2 e 3.
...
Quando esta fase for aceita, pergunte ao usuário: *"Salvar esta execução como recipe para repetirmos na Etapa 5?"* A recipe deve capturar: as decisões de modelo de dados feitas acima, os padrões de nomenclatura confirmados em `03-glossary-and-naming.md`, e quaisquer resoluções de perguntas do modo Build que surgiram.
